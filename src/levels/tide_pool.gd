...
const PLACED := [
	...
	["snail", Vector2(-31.5, -27.8), 240, 1.25],
	["snail", Vector2(35.1, -28.4), 60, 1.3],
	["snail", Vector2(-33.4, -13.2), 185, 1.15],
	["snail", Vector2(46.2, -6.3), 305, 1.4],
	["snail", Vector2(-45.6, -17.6), 20, 1.2],
	["snail", Vector2(33.9, -9.6), 130, 1.1],
	["snail", Vector2(-8.2, 21.6), 255, 1.3],
	["snail", Vector2(21.8, -1.1), 340, 1.2],
	...
	["periwinkle", Vector2(-1.2, -18.6), 300, 0.38],
	["periwinkle", Vector2(-6.1, -14.2), 45, 0.34],
	["periwinkle", Vector2(7.9, -18.4), 170, 0.42],
	["periwinkle", Vector2(-12.9, -19.6), 230, 0.36],
	["periwinkle", Vector2(0.4, -10.9), 10, 0.44],
	["periwinkle", Vector2(-4.3, -24.6), 120, 0.4],
	["periwinkle", Vector2(-3.6, -13.1), 250, 0.57],
	["periwinkle", Vector2(1.9, -16.8), 75, 0.61],
	["periwinkle", Vector2(-9.4, -11.2), 195, 0.52],
	["periwinkle", Vector2(-0.7, -22.3), 330, 0.64],
	["periwinkle", Vector2(8.6, -11.9), 140, 0.55],
	["periwinkle", Vector2(-10.9, -24.8), 20, 0.6],
	["periwinkle", Vector2(4.8, -20.7), 285, 0.5],
	["periwinkle", Vector2(-7.7, -16.9), 105, 0.58],
	["periwinkle", Vector2(-5.9, -4.1), 160, 0.62],
	["periwinkle", Vector2(7.6, -6.8), 95, 0.7],
	["periwinkle", Vector2(16.4, -10.2), 210, 0.66],
	["periwinkle", Vector2(21.7, -13.1), 330, 0.58],
	["periwinkle", Vector2(22.6, -25.1), 15, 0.74],
	["periwinkle", Vector2(31.8, -22.7), 125, 0.61],
	["periwinkle", Vector2(-20.3, -17.8), 70, 0.69],
	["periwinkle", Vector2(-18.2, -8.1), 305, 0.77],
	["periwinkle", Vector2(-28.6, -20.4), 50, 0.6],
	["periwinkle", Vector2(-8.7, -41.6), 140, 0.72],
	["periwinkle", Vector2(1.4, -40.3), 265, 0.57],
	["periwinkle", Vector2(10.9, -35.7), 20, 0.66],
	["periwinkle", Vector2(-11.6, 6.9), 290, 0.64],
	["periwinkle", Vector2(-7.1, 12.8), 110, 0.59],
	["periwinkle", Vector2(8.2, 4.6), 5, 0.62],
	["periwinkle", Vector2(14.7, 1.9), 150, 0.7],
	["periwinkle", Vector2(-45.1, 8.6), 200, 0.68],
	["periwinkle", Vector2(-41.2, -1.3), 320, 0.75],
	["periwinkle", Vector2(24.8, -6.1), 65, 0.63],
	["periwinkle", Vector2(-33.9, -24.6), 280, 0.58],
	["periwinkle", Vector2(11.8, -40.7), 150, 0.6],
	["periwinkle", Vector2(-35.8, 9.1), 25, 0.62],
	["periwinkle", Vector2(10.6, 12.1), 205, 0.57],
	["periwinkle", Vector2(-19.9, -1.4), 95, 0.55],
	["periwinkle", Vector2(27.7, 4.8), 315, 0.66],
	...
	["seashell", Vector2(-2.7, 29.8), 320, 1.5],
	["seashell", Vector2(22.9, 14.2), 25, 1.2],
	["seashell", Vector2(37.2, 11.4), 240, 1.6],
	["seashell", Vector2(-14.8, 40.1), 135, 1.35],
	["seashell", Vector2(-22.6, 3.9), 280, 1.45],
	["seashell", Vector2(31.1, 33.8), 100, 1.25],
	["seashell", Vector2(16.9, 13.6), 215, 1.4],
	["seashell", Vector2(-24.2, 39.9), 50, 1.2],
	...
	["sea_star", Vector2(-1.8, 20.4), 200, 1.4],
	["sea_star", Vector2(-25.6, -2.8), 35, 1.5],
	["sea_star", Vector2(17.4, -4.6), 290, 1.3],
	["sea_star", Vector2(35.5, 26.9), 160, 1.55],
	["sea_star", Vector2(-31.6, 35.4), 80, 1.35],
	["sea_star", Vector2(-11.9, 27.9), 250, 1.45],
	["sea_star", Vector2(38.6, -21.9), 15, 1.5],
	["sea_star", Vector2(9.9, 33.6), 120, 1.3],
	...
	["loose_rock", Vector2(6.4, 39.8), 250, 2.3],
	["loose_rock", Vector2(-49.1, -1.2), 75, 2.1],
	["loose_rock", Vector2(40.4, 17.6), 310, 2.4],
	["loose_rock", Vector2(23.8, 1.6), 200, 2.3],
...
func build(world: GameWorld) -> void:
	...
	var kinds := {
		...
		"periwinkle": {"model": "periwinkle", "label": "Periwinkle", "tier": 0, "density": 0.06, "whole": _rim, "fit": 1.14,
			"reason": "The periwinkle grazes the film of algae on the pool's rock and sand.", "build": _creep.bind(0.04, 0.4)},
		"seashell": {"model": "shell", "label": "Empty seashell", "tier": 1, "density": 0.03, "whole": _water,
			"reason": "Waves topping the spill carry empty shells in and leave them on the sand."},
		"loose_rock": {"model": "rock", "label": "Loose rock", "tier": 2, "density": 0.1, "whole": _rim,
			"reason": "A rock broken from the rim has rolled into the pool."},
		"beach_rock": {"model": "boulder", "label": "Beach rock", "tier": 3, "density": 0.07, "whole": _beach,
			"reason": "A rock fallen from the headland lies on the beach beside the pool."},
		"beach_boulder": {"model": "boulder", "label": "Beach boulder", "tier": 4, "density": 0.08, "whole": _beach,
			"reason": "A boulder fallen from the headland lies on the beach beside the pool."},
		...
		"anemone_rock": {"model": "boulder", "label": "Boulder with an anemone", "tier": 3, "density": 0.05, "whole": _rim,
			"reason": "A boulder broken from the rim lies in the pool.", "build": _anemone_on},
		"rim_boulder": {"model": "boulder", "label": "Pool rim boulder", "tier": 3, "density": 0.05,
			"whole": _rim, "reason": "Exposed bedrock forms the pool rim."},
		"anemone_rim": {"model": "boulder", "label": "Rim boulder with an anemone", "tier": 3, "density": 0.05,
...
func _build_spawns() -> void:
	_world.spawn({"kind": {"model": "plankton", "label": "Drifting plankton", "tier": 0, "density": 0.6,
		...
		"rate": 1.5, "limit": 9, "lifetime": 70.0, "move": _ride_current})
	_world.spawn({"kind": {"model": "small_fish", "label": "Fish fry", "tier": 1, "density": 0.12,
			...
			"lift": 0.3},
		"from": [NURSERY], "sizes": Vector2(0.55, 0.9), "tiers": Vector2i(1, 2),
		"rate": 0.8, "limit": 4, "lifetime": 18.0, "move": _dart})
	_world.spawn({"kind": {"model": "small_fish", "label": "Blenny", "tier": 2, "density": 0.09,
		...
		"rate": 0.45, "limit": 4, "lifetime": 45.0, "move": _loop})
	_world.spawn({"kind": {"model": "crab_body", "label": "Shore crab", "tier": 3, "density": 0.09,
		...
		"rate": 0.45, "limit": 4, "lifetime": 60.0, "move": _scuttle})
