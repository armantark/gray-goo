...
const PLACED := [
	...
	["glucose", Vector2(-2.5, -26.9), 40, 2.56],
	["fructose", Vector2(3.8, 34.8), 225, 2.7],
	["glucose", Vector2(44.3, -51.9), 285, 2.56],
	["fructose", Vector2(80.6, -14.2), 110, 2.7],
	["glucose", Vector2(-31.5, -58.8), 135, 2.56],
	["fructose", Vector2(78.1, 18.2), 265, 2.7],
	["glucose", Vector2(12.6, -40.1), 350, 2.56],
	["fructose", Vector2(-38.2, -41.7), 70, 2.7],
	["glucose", Vector2(42.1, 18.6), 190, 2.56],
	["fructose", Vector2(14.9, 58.4), 300, 2.7],
	["glucose", Vector2(66.8, 47.9), 25, 2.56],
	...
	["hydroxyl", Vector2(-38.7, -13.8), 250, 1.8],
	["water", Vector2(-20.2, -30.6), 165, 2.04],
	["o2", Vector2(-9.8, -37.5), 320, 2.1],
	["hydroxyl", Vector2(-73.8, -29.4), 20, 1.8],
	["h2", Vector2(-43.8, -31.9), 205, 1.35],
	...
	["lithium", Vector2(-39.6, 1.1), 0, 1.1],
	["lithium", Vector2(-43.6, 2.4), 0, 1.1],
	["beryllium", Vector2(-19.8, -4.2), 0, 1.2],
	["beryllium", Vector2(-66.1, -12.0), 0, 1.2],
	["helium", Vector2(-3.0, -13.9), 0, 0.85],
	...
	["boron", Vector2(-63.5, -6.8), 0, 1.3],
	["lithium", Vector2(-48.9, -2.3), 0, 1.1],
	["carbon", Vector2(-27.1, -15.8), 0, 1.4],
	["hydrogen", Vector2(-4.4, 28.3), 0, 0.8],
	...
	["nucleus", Vector2(-65.1, 17.2), 145, 0.55],
	["nucleus", Vector2(-70.6, 11.0), 260, 0.66],
	["nucleus", Vector2(-47.3, 7.9), 35, 0.6],
	["nucleus", Vector2(-42.8, -11.5), 120, 0.45],
	...
	["proton", Vector2(-40.6, 44.3), 145, 0.18],
	["neutron", Vector2(-41.3, 45.0), 25, 0.18],
	["proton", Vector2(-57.8, 31.9), 200, 0.18],
	["neutron", Vector2(-26.2, 22.9), 95, 0.18],
	["neutron", Vector2(-46.8, 17.6), 315, 0.18],
	["proton", Vector2(-23.1, 31.4), 60, 0.18],
	...
	["pion", Vector2(-45.6, 46.8), 170, 0.3],
	["pion", Vector2(-62.9, 25.1), 305, 0.27],
	["pion", Vector2(-27.4, 42.1), 55, 0.33],
	["pion", Vector2(-43.9, 19.7), 220, 0.29],
	["pion", Vector2(-53.8, 40.6), 125, 0.31],
