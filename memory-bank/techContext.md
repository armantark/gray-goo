...
On 2026-09-04, https://www.blender.org/releases/ listed Blender 5.2.1 LTS, updated August 25, 2026. The installed version remains 3.1.0. An update has not been performed. Blender CLI can run Python for asset creation, materials, rendering, and export. The third-party ahujasid/blender-mcp adds a live-session bridge and external asset-service integrations; those conveniences are not bundled CLI features.
