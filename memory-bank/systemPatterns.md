...
Composite consumption: individual parts and the whole have separate sizes and separate edibility. Consuming parts does not reduce the whole's size. Sugar structures with no visible constituents are collected with their last visible part; do not create replacement remnant food. Once eligible, consuming the whole consumes only its surviving parts; previously consumed parts contribute no second growth reward.
