...
LocalPool gates consumption by tier and radius. Tide water samples the basin terrain, masks dry cells, and lowers its surface as water disappears. Keep the remaining growth volume constant when the depth mask changes. Cosmic fabric opens with the Groups and clusters view and stays a local mopping surface; under the eat rule it is the growth that bridges galaxies to whole groups.
