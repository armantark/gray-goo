...
Composite consumption: individual parts and the whole have separate sizes and separate edibility. Consuming parts does not reduce the whole's size. Wholes that draw nothing of their own (Sugar structures, skateboards, open star clusters) are collected with their last visible part; do not create replacement remnant food. A part counts as visible while its own model or one of its parts shows, so an electron cloud whose electrons a size jump retired no longer holds its molecule on screen. Once eligible, consuming the whole consumes only its surviving parts; previously consumed parts contribute no second growth reward.
